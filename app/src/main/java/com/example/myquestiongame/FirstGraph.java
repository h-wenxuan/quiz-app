...
public class FirstGraph extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_first_graph);

        // Find the WebView by its ID
        WebView webView = findViewById(R.id.webView);

        // Load the URL into the WebView
        webView.loadUrl("http://10.0.2.2:9999/clicker/display");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(FirstGraph.this, SecondQuestion.class);
