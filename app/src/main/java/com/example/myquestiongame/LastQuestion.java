...
public class LastQuestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonA.setOnClickListener(v -> {
            ...
            webView.loadUrl("http://10.0.2.2:9999/clicker/selectlast?choice=A");
        ...
        buttonB.setOnClickListener(v -> {
            ...
            webView.loadUrl("http://10.0.2.2:9999/clicker/selectlast?choice=B");
        ...
        buttonC.setOnClickListener(v -> {
            ...
            webView.loadUrl("http://10.0.2.2:9999/clicker/selectlast?choice=C");
        ...
        buttonD.setOnClickListener(v -> {
            ...
            webView.loadUrl("http://10.0.2.2:9999/clicker/selectlast?choice=D");
    ...
    private void startActivityWithScore(String choice) {
        Intent intent = new Intent(LastQuestion.this, LastGraph.class);
